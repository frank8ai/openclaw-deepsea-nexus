# 🧠 OpenClaw Deep-Sea Nexus v5.3.0
...
- 保留 `v5.2.0` 的 runtime middleware 与 Windows 运维兼容性基线
...
- `health --json` 与 `paths --json` 现在可见 execution_guard 状态、metrics 与 guardrails 路径
