...
JOB_LINE="20 9 * * * cd /Users/yizhi/.openclaw/workspace/skills/deepsea-nexus && /usr/bin/python3 scripts/smart_context_param_advisor.py --lookback-hours 24 --min-events 8 >> /tmp/smart_context_param_advisor.cron.log 2>&1"
