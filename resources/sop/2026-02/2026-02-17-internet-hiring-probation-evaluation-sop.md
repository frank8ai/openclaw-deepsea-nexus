...
## Metadata
- SOP ID: SOP-20260217-37
- Name: 招聘面试与试用期评估
- Tags: internet, hiring, interview, probation
- Primary triggers: 岗位进入招聘阶段; 新成员进入试用期评估窗口
- Primary outputs: 结构化面试评分卡; 试用期目标与评估结论
- Owner: yizhi
- Team: deepsea-nexus
- Version: v1.0
- Status: active
...
- Best Practice compliance: 面试必须结构化评分，试用期必须目标化评估。；依据：NIST Information Quality:https://www.nist.gov/director/nist-information-quality-standards；PRISMA 2020:https://www.bmj.com/content/372/bmj.n71；DORA:https://dora.dev/；研究记录：resources/sop/2026-02/research-toolchain/internet-hiring-probation-evaluation-toolchain-research.md。
- Best Method compliance: 岗位画像 -> 结构化面试 -> 试用期里程碑评估。；依据：Winner A=4.55，Runner-up=3.70，Margin=0.85，硬约束=passed；研究记录：resources/sop/2026-02/research-toolchain/internet-hiring-probation-evaluation-toolchain-research.md。
- Best Tool compliance: 评分卡模板 + 题库管理 + 试用期目标看板。；依据：误判率下降 >=20%；试用期达标率提升 >=15%；回滚：回退到上一版题库和评分标准并复校；研究记录：resources/sop/2026-02/research-toolchain/internet-hiring-probation-evaluation-toolchain-research.md。
...
## Objective
降低招聘随机性，提升岗位匹配度与试用期成功率。

## Scope and Boundaries
- In scope: 岗位画像、面试题库、评分和试用期目标
- Out of scope: 薪酬谈判与法律合同签署
...
- Best Practice selected: 面试必须结构化评分，试用期必须目标化评估。（依据：resources/sop/2026-02/research-toolchain/internet-hiring-probation-evaluation-toolchain-research.md）
- Best Method selected: 岗位画像 -> 结构化面试 -> 试用期里程碑评估。（依据：Winner A=4.55，Margin=0.85）
- Best Tool selected: 评分卡模板 + 题库管理 + 试用期目标看板。（依据：resources/sop/2026-02/research-toolchain/internet-hiring-probation-evaluation-toolchain-research.md）
- Scorecard reference: resources/sop/2026-02/2026-02-17-internet-hiring-probation-evaluation-scorecard.md
...
- 本SOP研究记录: `resources/sop/2026-02/research-toolchain/internet-hiring-probation-evaluation-toolchain-research.md`
- 最佳实践: 面试必须结构化评分，试用期必须目标化评估。
- 最佳方法: 岗位画像 -> 结构化面试 -> 试用期里程碑评估。（Winner A=4.55, Margin=0.85）
- 最佳工具: 评分卡模板 + 题库管理 + 试用期目标看板。
- 本轮优化:
  - 将三优研究结论写入合规声明与执行流程。
  - 用非可协商约束 + 风险证据矩阵做发布门禁。
...
| 3 | 执行 招聘面试与试用期评估 核心流程 | 关键门禁全部通过 | 执行记录 |
...
- Log location: resources/sop/2026-02/2026-02-17-internet-hiring-probation-evaluation-iteration-log.md
...
## Release Readiness
- Validation command:
  - `python3 scripts/validate_sop_factory.py --sop resources/sop/2026-02/2026-02-17-internet-hiring-probation-evaluation-sop.md --strict`
...
## Links
- Scorecard: resources/sop/2026-02/2026-02-17-internet-hiring-probation-evaluation-scorecard.md
- Iteration log: resources/sop/2026-02/2026-02-17-internet-hiring-probation-evaluation-iteration-log.md
- Related decision cards: resources/decisions/2026-02/2026-02-17-closed-loop-pilot.md
- L0 abstract: resources/sop/2026-02/2026-02-17-internet-hiring-probation-evaluation-sop.abstract.md
- L1 overview: resources/sop/2026-02/2026-02-17-internet-hiring-probation-evaluation-sop.overview.md
