...
- Primary triggers: 新策略或功能需要实验验证; 核心指标波动但归因不明确
- Primary outputs: 实验方案与停止条件; 实验结论与规则更新
- Owner: yizhi
- Team: deepsea-nexus
- Version: v1.0
- Status: active
...
- Best Practice compliance: 实验评审必须明确主指标、护栏指标和停止条件。；依据：Microsoft Experimentation Platform:https://www.microsoft.com/en-us/research/group/experimentation-platform-exp/；DORA:https://dora.dev/；PRISMA-S:https://systematicreviewsjournal.biomedcentral.com/articles/10.1186/s13643-020-01542-z；研究记录：resources/sop/2026-02/research-toolchain/internet-metrics-experiment-review-toolchain-research.md。
- Best Method compliance: 假设 -> 干预 -> 指标 -> 幅度 -> 停止条件五段法。；依据：Winner A=4.55，Runner-up=3.70，Margin=0.85，硬约束=passed；研究记录：resources/sop/2026-02/research-toolchain/internet-metrics-experiment-review-toolchain-research.md。
- Best Tool compliance: 实验模板 + 指标看板 + 统计检查脚本。；依据：无效实验比例下降 >=25%；决策速度提升 >=20%；回滚：回退实验开关并恢复基线策略；研究记录：resources/sop/2026-02/research-toolchain/internet-metrics-experiment-review-toolchain-research.md。
...
## Objective
用主指标+护栏指标+停止条件提高实验决策质量，避免伪改进。

## Scope and Boundaries
- In scope: 指标定义、实验设计、评审和结论沉淀
- Out of scope: 直接改动生产逻辑实现
...
- Best Practice selected: 实验评审必须明确主指标、护栏指标和停止条件。（依据：resources/sop/2026-02/research-toolchain/internet-metrics-experiment-review-toolchain-research.md）
- Best Method selected: 假设 -> 干预 -> 指标 -> 幅度 -> 停止条件五段法。（依据：Winner A=4.55，Margin=0.85）
- Best Tool selected: 实验模板 + 指标看板 + 统计检查脚本。（依据：resources/sop/2026-02/research-toolchain/internet-metrics-experiment-review-toolchain-research.md）
- Scorecard reference: resources/sop/2026-02/2026-02-17-internet-metrics-experiment-review-scorecard.md
...
- 本SOP研究记录: `resources/sop/2026-02/research-toolchain/internet-metrics-experiment-review-toolchain-research.md`
- 最佳实践: 实验评审必须明确主指标、护栏指标和停止条件。
- 最佳方法: 假设 -> 干预 -> 指标 -> 幅度 -> 停止条件五段法。（Winner A=4.55, Margin=0.85）
...
| 3 | 执行 指标体系与实验评审 核心流程 | 关键门禁全部通过 | 执行记录 |
...
- Log location: resources/sop/2026-02/2026-02-17-internet-metrics-experiment-review-iteration-log.md
...
## Release Readiness
- Validation command:
  - `python3 scripts/validate_sop_factory.py --sop resources/sop/2026-02/2026-02-17-internet-metrics-experiment-review-sop.md --strict`
...
- Iteration log: resources/sop/2026-02/2026-02-17-internet-metrics-experiment-review-iteration-log.md
- Related decision cards: resources/decisions/2026-02/2026-02-17-closed-loop-pilot.md
- L0 abstract: resources/sop/2026-02/2026-02-17-internet-metrics-experiment-review-sop.abstract.md
- L1 overview: resources/sop/2026-02/2026-02-17-internet-metrics-experiment-review-sop.overview.md
