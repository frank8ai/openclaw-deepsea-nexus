...
## Metadata
- SOP ID: SOP-20260217-30
- Name: 需求评审与验收标准
- Tags: internet, requirements, prd, acceptance
- Primary triggers: PRD进入评审且涉及跨团队交付; 验收标准或不可协商约束缺失
- Primary outputs: 评审结论与风险清单; 验收用例与不可协商约束列表
- Owner: yizhi
- Team: deepsea-nexus
- Version: v1.0
- Status: active
...
- Best Practice compliance: 需求评审必须绑定验收用例与不可协商约束。；依据：PRISMA 2020:https://www.bmj.com/content/372/bmj.n71；NIST Information Quality:https://www.nist.gov/director/nist-information-quality-standards；NIST SSDF:https://csrc.nist.gov/pubs/sp/800/218/final；研究记录：resources/sop/2026-02/research-toolchain/internet-requirements-review-acceptance-toolchain-research.md。
- Best Method compliance: 三段评审（需求澄清 -> 约束核对 -> 验收走查）。；依据：Winner A=4.55，Runner-up=3.70，Margin=0.85，硬约束=passed；研究记录：resources/sop/2026-02/research-toolchain/internet-requirements-review-acceptance-toolchain-research.md。
- Best Tool compliance: PRD模板 + 验收用例模板 + 评审看板。；依据：评审漏项率下降 >=30%；返工率下降 >=25%；回滚：模板字段裁剪；看板回退到最小字段；研究记录：resources/sop/2026-02/research-toolchain/internet-requirements-review-acceptance-toolchain-research.md。
...
## Objective
把需求从“描述”升级为“可验收交付”，避免上线后返工和口径不一致。

## Scope and Boundaries
- In scope: PRD评审、验收标准定义、约束冻结
- Out of scope: 详细技术实现编码
...
## Outputs
- Output 1: 评审结论与风险清单
- Output 2: 验收用例与不可协商约束列表

## Three-Optimal Decision
- Best Practice selected: 需求评审必须绑定验收用例与不可协商约束。（依据：resources/sop/2026-02/research-toolchain/internet-requirements-review-acceptance-toolchain-research.md）
- Best Method selected: 三段评审（需求澄清 -> 约束核对 -> 验收走查）。（依据：Winner A=4.55，Margin=0.85）
- Best Tool selected: PRD模板 + 验收用例模板 + 评审看板。（依据：resources/sop/2026-02/research-toolchain/internet-requirements-review-acceptance-toolchain-research.md）
- Scorecard reference: resources/sop/2026-02/2026-02-17-internet-requirements-review-acceptance-scorecard.md
...
- 本SOP研究记录: `resources/sop/2026-02/research-toolchain/internet-requirements-review-acceptance-toolchain-research.md`
- 最佳实践: 需求评审必须绑定验收用例与不可协商约束。
- 最佳方法: 三段评审（需求澄清 -> 约束核对 -> 验收走查）。（Winner A=4.55, Margin=0.85）
...
| 3 | 执行 需求评审与验收标准 核心流程 | 关键门禁全部通过 | 执行记录 |
...
- Log location: resources/sop/2026-02/2026-02-17-internet-requirements-review-acceptance-iteration-log.md
...
## Release Readiness
- Validation command:
  - `python3 scripts/validate_sop_factory.py --sop resources/sop/2026-02/2026-02-17-internet-requirements-review-acceptance-sop.md --strict`
...
- Iteration log: resources/sop/2026-02/2026-02-17-internet-requirements-review-acceptance-iteration-log.md
- Related decision cards: resources/decisions/2026-02/2026-02-17-closed-loop-pilot.md
- L0 abstract: resources/sop/2026-02/2026-02-17-internet-requirements-review-acceptance-sop.abstract.md
- L1 overview: resources/sop/2026-02/2026-02-17-internet-requirements-review-acceptance-sop.overview.md
