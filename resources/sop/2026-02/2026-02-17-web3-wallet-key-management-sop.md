...
- Primary triggers: 新增资金地址或权限角色; 密钥轮换周期到期或异常访问
- Primary outputs: 权限分层与多签配置记录; 轮换演练和应急联系人清单
- Owner: yizhi
- Team: deepsea-nexus
- Version: v1.0
- Status: active
...
- Best Practice compliance: 私钥管理必须去单点化并可演练恢复。；依据：Safe Docs:https://help.safe.global/en/；NIST Key Management (SP 800-57):https://csrc.nist.gov/pubs/sp/800/57/pt1/r5/final；NIST SSDF:https://csrc.nist.gov/pubs/sp/800/218/final；研究记录：resources/sop/2026-02/research-toolchain/web3-wallet-key-management-toolchain-research.md。
- Best Method compliance: 权限分层 -> 多签审批 -> 周期轮换 -> 应急演练。；依据：Winner A=4.55，Runner-up=3.70，Margin=0.85，硬约束=passed；研究记录：resources/sop/2026-02/research-toolchain/web3-wallet-key-management-toolchain-research.md。
- Best Tool compliance: Safe多签 + HSM/硬件钱包 + 密钥审计台账。；依据：单点失陷风险下降 >=50%；权限违规下降 >=35%；回滚：立即吊销异常密钥并切换应急签名组；研究记录：resources/sop/2026-02/research-toolchain/web3-wallet-key-management-toolchain-research.md。
...
## Objective
通过分层权限和可演练密钥体系降低单点失陷风险。

## Scope and Boundaries
- In scope: 多签策略、权限分层、硬件钱包、轮换和应急
- Out of scope: 交易策略执行
...
## Outputs
- Output 1: 权限分层与多签配置记录
- Output 2: 轮换演练和应急联系人清单

## Three-Optimal Decision
- Best Practice selected: 私钥管理必须去单点化并可演练恢复。（依据：resources/sop/2026-02/research-toolchain/web3-wallet-key-management-toolchain-research.md）
- Best Method selected: 权限分层 -> 多签审批 -> 周期轮换 -> 应急演练。（依据：Winner A=4.55，Margin=0.85）
- Best Tool selected: Safe多签 + HSM/硬件钱包 + 密钥审计台账。（依据：resources/sop/2026-02/research-toolchain/web3-wallet-key-management-toolchain-research.md）
- Scorecard reference: resources/sop/2026-02/2026-02-17-web3-wallet-key-management-scorecard.md
...
- 本SOP研究记录: `resources/sop/2026-02/research-toolchain/web3-wallet-key-management-toolchain-research.md`
- 最佳实践: 私钥管理必须去单点化并可演练恢复。
- 最佳方法: 权限分层 -> 多签审批 -> 周期轮换 -> 应急演练。（Winner A=4.55, Margin=0.85）
...
| 3 | 执行 钱包与密钥管理 核心流程 | 关键门禁全部通过 | 执行记录 |
...
- Log location: resources/sop/2026-02/2026-02-17-web3-wallet-key-management-iteration-log.md
...
## Release Readiness
- Validation command:
  - `python3 scripts/validate_sop_factory.py --sop resources/sop/2026-02/2026-02-17-web3-wallet-key-management-sop.md --strict`
...
- Iteration log: resources/sop/2026-02/2026-02-17-web3-wallet-key-management-iteration-log.md
- Related decision cards: resources/decisions/2026-02/2026-02-17-closed-loop-pilot.md
- L0 abstract: resources/sop/2026-02/2026-02-17-web3-wallet-key-management-sop.abstract.md
- L1 overview: resources/sop/2026-02/2026-02-17-web3-wallet-key-management-sop.overview.md
