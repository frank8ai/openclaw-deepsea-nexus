...
## Metadata
- SOP ID: SOP-20260217-49
- Name: PR危机沟通（Web3）
- Tags: web3, pr, crisis, communication
- Primary triggers: FUD/谣言快速扩散或价格异常波动; 安全事件或系统故障引发舆情风险
- Primary outputs: 统一口径公告与证据节奏计划; 危机沟通复盘与规则更新
- Owner: yizhi
- Team: deepsea-nexus
- Version: v1.0
- Status: active
...
- Best Practice compliance: 危机沟通必须事实先行、节奏可控、口径统一。；依据：CDC CERC:https://emergency.cdc.gov/cerc/；CISA Incident Response Playbooks:https://www.cisa.gov/news-events/news/cisa-releases-updated-cybersecurity-incident-and-vulnerability-response-playbooks；NIST Information Quality:https://www.nist.gov/director/nist-information-quality-standards；研究记录：resources/sop/2026-02/research-toolchain/web3-pr-crisis-communication-toolchain-research.md。
- Best Method compliance: 事实确认 -> 首次公告 -> 周期更新 -> 复盘澄清。；依据：Winner A=4.55，Runner-up=3.70，Margin=0.85，硬约束=passed；研究记录：resources/sop/2026-02/research-toolchain/web3-pr-crisis-communication-toolchain-research.md。
- Best Tool compliance: 公告模板 + 状态页 + 问答口径库。；依据：信息一致性提升 >=30%；谣言扩散窗口缩短 >=25%；回滚：下架错误公告并发布更正说明；研究记录：resources/sop/2026-02/research-toolchain/web3-pr-crisis-communication-toolchain-research.md。
...
## Objective
在危机场景下保持对外信息一致、透明、可验证，控制二次伤害。

## Scope and Boundaries
- In scope: 危机分级、公告节奏、证据发布、问答口径
- Out of scope: 市场投放活动执行
- Dependencies: PR团队、法务审核、状态页/公告渠道

## Trigger Conditions (if/then)
- IF FUD/谣言快速扩散或价格异常波动
...
## Outputs
- Output 1: 统一口径公告与证据节奏计划
- Output 2: 危机沟通复盘与规则更新

## Three-Optimal Decision
- Best Practice selected: 危机沟通必须事实先行、节奏可控、口径统一。（依据：resources/sop/2026-02/research-toolchain/web3-pr-crisis-communication-toolchain-research.md）
- Best Method selected: 事实确认 -> 首次公告 -> 周期更新 -> 复盘澄清。（依据：Winner A=4.55，Margin=0.85）
- Best Tool selected: 公告模板 + 状态页 + 问答口径库。（依据：resources/sop/2026-02/research-toolchain/web3-pr-crisis-communication-toolchain-research.md）
- Scorecard reference: resources/sop/2026-02/2026-02-17-web3-pr-crisis-communication-scorecard.md
...
- 本SOP研究记录: `resources/sop/2026-02/research-toolchain/web3-pr-crisis-communication-toolchain-research.md`
- 最佳实践: 危机沟通必须事实先行、节奏可控、口径统一。
- 最佳方法: 事实确认 -> 首次公告 -> 周期更新 -> 复盘澄清。（Winner A=4.55, Margin=0.85）
- 最佳工具: 公告模板 + 状态页 + 问答口径库。
- 本轮优化:
  - 将三优研究结论写入合规声明与执行流程。
  - 用非可协商约束 + 风险证据矩阵做发布门禁。
...
| 3 | 执行 PR危机沟通（Web3） 核心流程 | 关键门禁全部通过 | 执行记录 |
...
- Log location: resources/sop/2026-02/2026-02-17-web3-pr-crisis-communication-iteration-log.md
...
## Release Readiness
- Validation command:
  - `python3 scripts/validate_sop_factory.py --sop resources/sop/2026-02/2026-02-17-web3-pr-crisis-communication-sop.md --strict`
...
## Links
- Scorecard: resources/sop/2026-02/2026-02-17-web3-pr-crisis-communication-scorecard.md
- Iteration log: resources/sop/2026-02/2026-02-17-web3-pr-crisis-communication-iteration-log.md
- Related decision cards: resources/decisions/2026-02/2026-02-17-closed-loop-pilot.md
- L0 abstract: resources/sop/2026-02/2026-02-17-web3-pr-crisis-communication-sop.abstract.md
- L1 overview: resources/sop/2026-02/2026-02-17-web3-pr-crisis-communication-sop.overview.md
