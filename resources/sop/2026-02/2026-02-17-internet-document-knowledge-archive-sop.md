...
## Metadata
- SOP ID: SOP-20260217-36
- Name: 文档与知识归档（互联网）
- Tags: internet, documentation, knowledge, archive
- Primary triggers: 关键决策或架构变更完成; 同类问题重复出现 >=2 次
- Primary outputs: 结构化文档条目（ADR/决策卡）; 版本审计与索引更新
- Owner: yizhi
- Team: deepsea-nexus
- Version: v1.0
- Status: active
...
- Best Practice compliance: 关键决策必须沉淀为可检索文档并绑定证据。；依据：NIST Information Quality:https://www.nist.gov/director/nist-information-quality-standards；PRISMA-S:https://systematicreviewsjournal.biomedcentral.com/articles/10.1186/s13643-020-01542-z；DORA:https://dora.dev/；研究记录：resources/sop/2026-02/research-toolchain/internet-document-knowledge-archive-toolchain-research.md。
- Best Method compliance: 模板化记录 + 标签索引 + 月度审计。；依据：Winner A=4.55，Runner-up=3.70，Margin=0.85，硬约束=passed；研究记录：resources/sop/2026-02/research-toolchain/internet-document-knowledge-archive-toolchain-research.md。
- Best Tool compliance: ADR模板 + 索引脚本 + 路径校验器。；依据：召回命中率提升 >=25%；失链率下降 >=30%；回滚：回滚错误条目并恢复上一版索引；研究记录：resources/sop/2026-02/research-toolchain/internet-document-knowledge-archive-toolchain-research.md。
...
## Objective
保证关键决策与变更可追溯、可检索、可复用。

## Scope and Boundaries
- In scope: ADR、决策卡、变更记录、版本审计
- Out of scope: 临时草稿和无结论讨论
...
## Outputs
- Output 1: 结构化文档条目（ADR/决策卡）
- Output 2: 版本审计与索引更新

## Three-Optimal Decision
- Best Practice selected: 关键决策必须沉淀为可检索文档并绑定证据。（依据：resources/sop/2026-02/research-toolchain/internet-document-knowledge-archive-toolchain-research.md）
- Best Method selected: 模板化记录 + 标签索引 + 月度审计。（依据：Winner A=4.55，Margin=0.85）
- Best Tool selected: ADR模板 + 索引脚本 + 路径校验器。（依据：resources/sop/2026-02/research-toolchain/internet-document-knowledge-archive-toolchain-research.md）
- Scorecard reference: resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-scorecard.md
...
- 本SOP研究记录: `resources/sop/2026-02/research-toolchain/internet-document-knowledge-archive-toolchain-research.md`
- 最佳实践: 关键决策必须沉淀为可检索文档并绑定证据。
- 最佳方法: 模板化记录 + 标签索引 + 月度审计。（Winner A=4.55, Margin=0.85）
- 最佳工具: ADR模板 + 索引脚本 + 路径校验器。
- 本轮优化:
  - 将三优研究结论写入合规声明与执行流程。
  - 用非可协商约束 + 风险证据矩阵做发布门禁。
...
| 3 | 执行 文档与知识归档（互联网） 核心流程 | 关键门禁全部通过 | 执行记录 |
...
- Log location: resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-iteration-log.md
...
## Release Readiness
- Validation command:
  - `python3 scripts/validate_sop_factory.py --sop resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-sop.md --strict`
...
## Links
- Scorecard: resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-scorecard.md
- Iteration log: resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-iteration-log.md
- Related decision cards: resources/decisions/2026-02/2026-02-17-closed-loop-pilot.md
- L0 abstract: resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-sop.abstract.md
- L1 overview: resources/sop/2026-02/2026-02-17-internet-document-knowledge-archive-sop.overview.md
